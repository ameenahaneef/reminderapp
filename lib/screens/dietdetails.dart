      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            Center(child: Image.file(File(category.imagePath),height: 200,width: 200,)),
                ...
                child: Card(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text('Day ${day + 1}'),
                        for (int meal = 0; meal < category.mealPlan[day].length; meal++)
                          Text('${mealTimes[meal]}: ${category.mealPlan[day][meal]}'),
